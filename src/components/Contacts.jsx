    ...
    return (
      <section id="contacts" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
          <div className="mb-12 lg:grid lg:grid-cols-2">
            <h2 className="headline-2 lg:max-w-[12ch] reveal-up">Contacts</h2>
            <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">Pour toute question n&apos;hesites pas à me contacter</p>
            <div className="flex items-center gap-2 mt-auto">
              {socialLinks.map(({ href, icon }, key) => (
                <a key={key} href={href} target="_blank" className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color, color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zing-50/80 reveal-up">
                  {icon}
                </a>
              ))}
            </div>
          </div>
          <form action="https://getform.io/f/azyyzelb" method="POST" className="xl:pl-10 2xl:pl-20">
